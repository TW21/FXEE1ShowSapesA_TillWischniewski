...
import controller.MRectangleController;
import controller.MCircleController;
        ...
        try {
            ...
            for (MShape s : shapes) {
                ...
                if (s instanceof MRectangle) {
                    ...
                    rec.setOnMouseClicked(new MRectangleController(srec, rec, text));
                    ...
                    circ.setOnMouseClicked(new MCircleController(sc,circ,text));
